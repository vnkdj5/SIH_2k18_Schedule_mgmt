...
$querry = "SELECT m.Contact, m.Name,c.title from minister_info as m , create_event as c ,guests as g WHERE g.Status=1 and c.date='$curDate' AND g.event_id=c.event_id AND g.guest_id=m.Minister_ID";
